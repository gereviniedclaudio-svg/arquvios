/**
 * Blackcat Payment Gateway via checkout PHP
 */
class BlackcatPayment {
    constructor() {
        ...
        this.resolveAmount();
        console.log('✅ Blackcat Payment inicializado');
    }
    ...
    async createPixTransaction(userData, addressData) {
        try {
            ...
            console.log('📤 Criando PIX na Blackcat via /checkout/pagamento.php', { valor: payload.valor, cpf: payload.cpf });
            ...
            console.log('✅ PIX gerado (Blackcat):', result.transactionId);
            return result;
        } catch (error) {
            console.error('❌ Erro ao criar PIX na Blackcat:', error);
    ...
    async checkTransactionStatus(transactionId) {
        try {
            ...
            console.error('❌ Erro ao verificar status (Blackcat):', error);
    ...
    sendTrackingEvents(eventName, transactionId, amount = null) {
        ...
        console.log('📊 Tracking (Blackcat):', eventName, transactionId, value);
    }
}

window.BlackcatPayment = BlackcatPayment;
